...
namespace RainbowTaskbar.UserControls
{
    ...
    public partial class ColorInstructionControl : UserControl
    {
        ...
        private void ColorPicker1_SelectedColorChanged(object sender, System.Windows.RoutedPropertyChangedEventArgs<System.Windows.Media.Color?> e)
        {
            if(SelectedEffect.SelectedItem is ColorInstructionEffect instructionEffect)
            {
                if(instructionEffect == ColorInstructionEffect.Gradient || instructionEffect == ColorInstructionEffect.FadeGradient)
                {
                    if (ColorPicker1.SelectedColor.HasValue && ColorPicker2.SelectedColor.HasValue)
                        PreviewRectangle.Fill = new LinearGradientBrush(ColorPicker1.SelectedColor.Value, ColorPicker2.SelectedColor.Value, 0);
                }
        ...
        private void Randomize_Checked(object sender, System.Windows.RoutedEventArgs e)
        {
