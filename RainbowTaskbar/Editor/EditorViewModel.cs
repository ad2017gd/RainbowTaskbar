...
public class AddInstructionCommand : ICommand {
    ...
    public void Execute(object parameter) {
       /* var index = editorViewModel.SelectedInstructionIndex + 1 ?? 0;
...
public class RemoveInstructionCommand : ICommand {
    ...
    public bool CanExecute(object parameter) => /*editorViewModel.SelectedInstructionIndex > -1*/ true;

    public void Execute(object parameter) {
        /*if (editorViewModel.SelectedInstructionIndex is { } selectedInstructionIndex && selectedInstructionIndex != -1) {
...
public class InstructionsToPresetCommand : ICommand {
    ...
    public bool CanExecute(object parameter) => /*App.Config is not null && App.Config.Instructions.Count > 0*/ true;
