...
namespace RainbowTaskbar.Helpers
{
    public class WindowHelper
    {
        ...
        public int Radius = 0;
        public TaskbarHelper taskbar = null;
        ...
        {
            return (new WindowInteropHelper(Window.GetWindow(window))).EnsureHandle();
        }

        public void Init(TaskbarHelper taskbarHelper)
        {
            HWND = GetHWND(window);
            SetWindowLong(HWND, (int)GWL.EXSTYLE, (uint)GetWindowLong(HWND, (int)GWL.EXSTYLE).ToInt32() | (uint)WS_EX.TRANSPARENT);
            SetWindowLong(HWND, (int)GWL.STYLE, (uint)GetWindowLong(HWND, (int)GWL.STYLE).ToInt32() | (uint)WS.POPUP | (uint)WS.VISIBLE);
