...
<p>Useful tool for Windows taskbar customization. Supports color effects, transitions, blur, images, text, rounded corners, transparency and a new HTTP API. Now rewritten in .NET 6!</p>
